    ...
    (let ((ty1 (apply-subst-to-type ty1 subst))
      ...
      (cond
        ...
        ((and (pair-type? ty1) (pair-type? ty2))
          (let
            ( [subst (unifier (pair-type->first ty1) (pair-type->first ty2) subst exp)])
            (unifier (pair-type->second ty1) (pair-type->second ty2) subst exp)))
  ...
  (lambda (tvar ty)
    (cases type ty
      ...
      (pair-type (first second)
        (and
          (no-occurrence? first ty)
          (no-occurrence? second ty)))
