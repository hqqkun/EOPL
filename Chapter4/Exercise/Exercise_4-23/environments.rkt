...
(require "store.rkt")
(provide init-env empty-env extend-env extend-env* extend-env-uninit* apply-env)
...
(define apply-env
  (lambda (env search-var)
    (cases environment env
      ...
      (extend-env-rec* (p-names list-b-vars p-bodies saved-env)
