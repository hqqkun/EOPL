  ...
  (lambda (exp env cont)
    (cases expression exp
      ...
      (let3-exp (var1 exp1 var2 exp2 var3 exp3 body)
        (value-of/k exp1 env
          (let3-1-cont var1 var2 exp2 var3 exp3 body env cont)))
...
(define apply-cont
  (lambda (cont val)
    (cases continuation cont
      (let3-1-cont (var1 var2 exp2 var3 exp3 body saved-env saved-cont)
        (value-of/k exp2 saved-env
          (let3-2-cont (cons var1 val) var2 var3 exp3 body saved-env saved-cont)))
      
      (let3-2-cont (p1 var2 var3 exp3 body saved-env saved-cont)
        (value-of/k exp3 saved-env
          (let3-3-cont p1 (cons var2 val) var3 body saved-env saved-cont)))
      
      (let3-3-cont (p1 p2 var3 body saved-env saved-cont)
        (value-of/k body
          (extend-env (car p1) (cdr p1)
            (extend-env (car p2) (cdr p2)
